...
const Footer = () => {
  ...
  return (
    <footer className="border-t bg-amber-900">
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-sm uppercase mb-4 tracking-wider text-white">Quick Links</h4>
            <ul className="flex flex-col gap-2 text-sm text-white-600">
              <li><Link href="/" className="hover:text-white transition-colors">Home</Link></li>
              <li><Link href="/all-photos" className="hover:text-white transition-colors">All Photos</Link></li>
          ...
          {/* Legal & Support */}
          <div>
            <h4 className="font-bold text-sm uppercase mb-4 tracking-wider text-white">Support</h4>
